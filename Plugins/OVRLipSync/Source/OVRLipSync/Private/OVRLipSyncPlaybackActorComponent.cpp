...
void UOVRLipSyncPlaybackActorComponent::SetAudioComponents(TArray<USoundBase*> inSoundBases) 
{
	for(USoundBase* Sound : inSoundBases)
	{
		AudioComponent->SetSound(Sound);
		SoundComponents.Add(AudioComponent);		
	}
}

void UOVRLipSyncPlaybackActorComponent::SetAudioComponent(USoundBase* inSoundBase) 
{ 
	AudioComponent->SetSound(inSoundBase);
}
