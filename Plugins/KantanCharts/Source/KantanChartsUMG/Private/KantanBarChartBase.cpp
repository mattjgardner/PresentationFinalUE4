...
//My addition to this module, adapted from SetMaxBarValue function above
void UKantanBarChartBase::SetMinBarValue(float InMinValue)
{
	MinBarValue = InMinValue;
	if (MyChart.IsValid())
	{
		GetBarChart()->SetMinBarValue(MinBarValue);
	}
}
