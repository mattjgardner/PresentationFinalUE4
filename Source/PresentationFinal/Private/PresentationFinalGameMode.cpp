...
//void APresentationFinalGameMode:: SpawnAndPossessVehiclePawn(APresentationFinalCharacter* inCharacter, APlayerController* inPlayerController, TSubclassOf<APawn> inPawn)
//{
//	APhysXVehicle* SpawnedVehicle;
...
//		SpawnedVehicle = Cast<APhysXVehicle>(SpawnedPawn);
//	}
//
//	inPlayerController->Possess(SpawnedVehicle);
//}